    ...
    return (
      <div className="website-page mx32">
        ...
        <p className="my8">
          ...
          your relationship with http://ghostit.co/ website (the “Service”)
          operated by Ghostit (“us”, “we”, or “our”).
        </p>
        <p className="my8">
        ...
        <p className="my8">
          ...
          the Service you agree to be bound by these Terms and accept all legal
          consequences. If you do not agree to these terms and conditions, in
          whole or in part, please do not use the Service.
        </p>
        <h4 className="my16">Purchases</h4>
        ...
        <p className="my8">
          ...
          (ii) the information you supply to us is true, correct and complete.By
        ...
        <h4 className="my16">Availability, Errors and Inaccuracies</h4>
        <p className="my8">
        ...
        <p className="my8">
          Despite our best efforts, the products or services available on our
          Service may have an error regarding the price, be inaccurately
          described, or be unavailable.We may experience delays in updating
          information on the Service and in our advertising on other websites.
        </p>
        <h4 className="my16">Subscriptions</h4>
        <p className="my8">
        ...
        <p className="my8">
          ...
          renew under the exact same conditions unless you cancel it or Ghostit
          cancels it. You may cancel your Subscription renewal either through
          your online account management page or by contacting Ghostit customer
          support team.
        </p>
        <p className="my8">
          ...
          Ghostit with accurate and complete billing information including full
          ...
          automatically authorize Ghostit to charge all Subscription fees
          incurred through your account to any such payment instruments.
        </p>
        <p className="my8">
          Should automatic billing fail to occur for any reason, Ghostit will
        ...
        <h4 className="my16">Free Trial</h4>
        <p className="my8">
          Ghostit may, at its sole discretion, offer a Subscription with a free
          trial for a limited period of time (“Free Trial”).You may be required
          to enter your billing information in order to sign up for the Free
          Trial.If you do enter your billing information when signing up for the
          Free Trial, you will not be charged by Ghostit until the Free Trial
        ...
        <p className="my8">
          At any time and without notice, Ghostit reserves the right to (i)
          modify the terms and conditions of the Free Trial offer, or (ii)
          cancel such Free Trial offer.Fee ChangesGhostit , in its sole
          discretion and at any time, may modify the Subscription fees for the
          Subscriptions. Any Subscription fee change will become effective at
          the end of the then-current Billing Cycle.
        </p>
        <p className="my8">
          Ghostit will provide you with a reasonable prior notice of any change
        ...
        <h4 className="my16">Refunds</h4>
        <p className="my8">
          Certain refund requests for Subscriptions may be considered by Ghostit
          on a case-by-case basis and granted in sole discretion of Ghostit.
        </p>
        <h4 className="my16">Content</h4>
        <p className="my8">
        ...
        <p className="my8">
          ...
          We reserve all rights to block or remove communications or materials
          ...
          offensive or otherwise unacceptable to us in our sole discretion. You
          acknowledge that, by providing you with the ability to view and
          distribute user-generated content on the Service, we are merely acting
          as a passive conduit for such distribution and is not undertaking any
          obligation or liability relating to any contents or activities on the
          Service.
        </p>
        <h4 className="my16">Accounts</h4>
        <p className="my8">
        ...
        <h4 className="my16">Intellectual Property</h4>
        <p className="my8">
          The Service and all contents, including but not limited to text,
          images, graphics or code are the property of Ghostit and are protected
          ...
          non-commercial use, or to place an order with Ghostit.
        </p>
        <p className="my8">
          Any other use is strictly prohibited and may violate copyright,
          trademark and other laws. These Terms do not grant you a license to
          use any trademark of Ghostit or its affiliates. You further agree not
          to use, change or delete any proprietary notices from materials
          downloaded from the Service.
        </p>
        <h4 className="my16">Links To Other Web Sites</h4>

        <p className="my8">
          The Service may contain links to third-party web sites or services
          that are not owned or controlled by Ghostit. Ghostit has no control
          ...
          further acknowledge and agree that Ghostit shall not be responsible or
        ...
        <h4 className="my16">Termination</h4>
        <p className="my8">
          We may terminate or suspend access to our Service immediately, without
          prior notice or liability, for any reason whatsoever, including,
          without limitation, if you breach the Terms. All provisions of the
          Terms shall survive termination, including, without limitation,
          ownership provisions, warranty disclaimers, indemnity and limitations
          of liability.Upon termination, your right to use the Service will
          immediately cease. If you wish to terminate your account, you may
          simply discontinue using the Service.
        </p>
        <h4 className="my16">Indemnification</h4>
        <p className="my8">
          You agree to indemnify, defend and hold harmless Ghostit, its
          ...
          actions or demands.These include but are not limited to: (a) legal and
          accounting fees resulting from your use of the Service; (b) your
          breach of any of these Terms; (c) anything you post on or upload to
          the Service; and (d) any activity related to your account. This
          includes any negligent or illegal conduct by you, any person or entity
          accessing the Service using your account whether such access is
          obtained via fraudulent or illegal means.Limitation Of
          LiabilityGhostit , its directors, employees, partners, agents,
          ...
          damages, including without limitation, economic loss, loss or damage
          ...
          of any third-party on or related to the Service; (iiv) any content
        ...
        <h4 className="my16">Disclaimer And Non-Waiver of Rights</h4>
        <p className="my8">
          Ghostit makes no guarantees, representations or warranties of any kind
          as regards the website and associated technology. Any purportedly
          applicable warranties, terms and conditions are excluded, to the
          fullest extent permitted by law. Your use of the Service is at your
          ...
          or course of performance, except as provided for under the laws of any
          province in Canada. In such cases, the provincial law shall apply to
          the extent necessary.Ghostit its subsidiaries, affiliates, and its
          ...
          and Ghostit chooses not to immediately act, or chooses not to act at
          all, Ghostit will still be entitled to all rights and remedies at any
          later date, or in any other situation, where you breach these Terms.
          Ghostit does not waive any of its rights. Ghostit shall not be
        ...
        <h4 className="my16">Exclusions</h4>
        ...
        <h4 className="my16">Governing Law</h4>
        <p className="my8">
          These Terms shall be governed by, and interpreted and enforced in
          accordance with, the laws in the Province of British Columbia and the
          laws of Canada, as applicable.If any provision of these Terms is held
