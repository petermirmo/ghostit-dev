...
const calendarEvents = [
  {
    ...
    posts: [
      ...
      },
      {
        ...
        instructions:
          "If you have the budget, running small ads ($50-250) per blog post will help you get in front of your audience faster. Your goal for blogging as a business should be to drive people back to your site and an ad will accelerate this. This step can be reserved for your biggest posts and doesn’t have to be completed every time you publish a blog post. ",
        postingDate: new moment().add(4, "day"),
        linkImage: "",
        socialType: "custom",
        campaignID: "5b9add6ef3c75900146c21f7",
        name: "Run Facebook Ad",
      ...
      },
      {
        ...
        postingDate: new moment().add(6, "day"),
        linkImage: "",
        socialType: "custom",
        campaignID: "5b9add6ef3c75900146c21f7",
  ...
  },
  {
    ...
    startDate: new moment().add(3, "day"),
    ...
    posts: [
      ...
      },
      {
        ...
        instructions: "n",
        postingDate: new moment().add(5, "day"),
        link: "",
        linkImage: "",
        accountType: "profile",
        socialType: "twitter",
  ...
  },
  {
    ...
    startDate: new moment().add(10, "day"),
    endDate: new moment().add(24, "day"),
    ...
    posts: [
      ...
      },
      {
        ...
        postingDate: new moment().add(11, "day"),
        linkImage: "",
        socialType: "custom",
        campaignID: "5be0d6c086fa840013d52546",
      ...
      },
      {
        ...
        postingDate: new moment().add(14, "day"),
        linkImage: "",
        socialType: "custom",
        campaignID: "5be0d6c086fa840013d52546",
        name:
      ...
      },
      {
        ...
        postingDate: new moment().add(15, "day"),
        linkImage: "",
        socialType: "custom",
        campaignID: "5be0d6c086fa840013d52546",
      ...
      },
      {
        ...
        postingDate: new moment().add(18, "day"),
        linkImage: "",
        socialType: "custom",
        campaignID: "5be0d6c086fa840013d52546",
