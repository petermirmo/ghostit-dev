      ...
      <div className="modal center">
        <div className="modal-content onboarding-modal">
          ...
          <div className="modal-header onboarding-header">
            ...
            <h4 className={"onboarding-title center " + animateDirection}>
              {headerMessage}
            </h4>
          </div>
          ...
          <div className="modal-body onboarding-body">
            ...
            {activePageNumber === 2 && (
              <div className={"active-tab " + animateDirection}>
                ...
                <p className="onboarding-info">
                  All we need is the name of 3 or more competitors! We will do
                  the rest!
                  <br />
                  Note: This information is only used to outrank your
                  competition in Google searches!
                </p>
              </div>
            )}
            {activePageNumber === 3 && (
              <div className={"active-tab " + animateDirection}>
                ...
                />
                <p className="onboarding-info">
                  Example: We sell to tech companies, 1-15 employees based in
                  US, UK, Canada and Australia. The decision maker in these
                  companies are marketing managers and the problems they are
                  looking to solve are content marketing strategy, content
                  marketing production, user acquisition and generating organic
                  website inbound.
                </p>
              </div>
            )}
            {activePageNumber === 4 && (
              <div className={"active-tab " + animateDirection}>
                ...
                />
                <p className="onboarding-info">
                  Example: Our brand is fun, somewhat cheeky, informative and
                  actionable.
                  <br />
                  We look for insparation like Ahrefs, nerd wallet and hubspot.
                  <br />
                  Things we look to avoid: generic, non-actionable, non-value
                  additive content.
                </p>
              </div>
            )}
            {activePageNumber === 5 && (
              <div className={"active-tab " + animateDirection}>
                ...
                />
                <p className="onboarding-info">
                  This can be anything! If you want to send us a happy face,
                  send us a happy face :)
                </p>
              </div>
            )}
            {activePageNumber === 6 && (
          ...
          <div className="modal-footer onboarding-footer">
            {activePageNumber !== 1 && (
              <button
                className="bottom-back-button-top"
                onClick={() => this.changeTab(-1, "animate-left")}
              >
